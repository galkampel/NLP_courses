...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.input_placeholder = tf.placeholder(tf.float32,(Config.batch_size,Config.n_features),name='input_placeholder')
        self.labels_placeholder = tf.placeholder(tf.float32,(Config.batch_size,Config.n_classes),name='labels_placeholder')
        ### END YOUR CODE
    ...
    def add_prediction_op(self):
        ...
        W = tf.Variable(tf.zeros((Config.n_features,Config.n_classes)),name='W')
        b =  tf.Variable(tf.zeros((Config.batch_size,Config.n_classes)),name='b')
